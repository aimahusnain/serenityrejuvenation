        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="bg-white dark:bg-[#7a219f] rounded-2xl p-8 shadow-sm border border-[#7a219f]/10 dark:border-[#efcafe]/20">
            <p className="text-[#7a219f]/70 dark:text-[#efcafe]/70 leading-relaxed text-lg">
              Welcome to <strong className="text-[#7a219f] dark:text-[#efcafe]">Serenity Rejuvenation</strong>. These Terms and Conditions govern your use of our website, booking services, and all spa treatments provided by our establishment.
            </p>
