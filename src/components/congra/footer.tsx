  ...
  return (
    <footer className="bg-black text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-400 leading-relaxed">
                Enhance your natural beauty with our customized aesthetic
                treatments.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-neutral-300 mb-6">(404) 446-9566</p>
            ...
            <div>
              ...
              <p className="text-sm text-neutral-300 leading-relaxed">
                371 E. Paces Ferry Rd. Suite 551,
                <br />
                Atlanta, GA 30305
              </p>
            </div>
      ...
      <div className="border-t border-neutral-700 py-6">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-neutral-400">
          <p>
            ©2026 Serenity Rejuvenation Aesthetics and Wellness | All Rights
